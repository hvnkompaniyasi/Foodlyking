...
export default function OrdersPage() {
  ...
  const steps = [
    { label: 'Tasdiqlandi', icon: CheckCircle2, completed: true },
    { label: 'Tayyorlanmoqda', icon: UtensilsCrossed, active: true },
    { label: 'Olingan', icon: Package, completed: false },
    { label: 'Sizga yaqin', icon: Bike, completed: false }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-3xl font-bold font-headline mb-8">Faol Buyurtmalar</h1>
        
        <Card className="border-none shadow-2xl rounded-3xl overflow-hidden bg-white mb-12">
          <CardHeader className="bg-primary text-white p-8">
            <div className="flex justify-between items-start mb-4">
              <div>
                <CardTitle className="text-3xl font-bold font-headline">Buyurtma #{currentOrder.id}</CardTitle>
                <p className="opacity-90 mt-1">{currentOrder.restaurant} restoranidan</p>
              </div>
          ...
          <CardContent className="p-8">
            ...
            <div className="flex items-center gap-4 bg-accent/5 p-4 rounded-2xl border border-accent/20">
              ...
              <div>
                <p className="font-bold text-accent">Kuryer: John Smith</p>
                <p className="text-sm text-muted-foreground">Hozirda restoranda buyurtmani kutmoqda.</p>
              </div>
            </div>
          </CardContent>
        </Card>

        <h2 className="text-2xl font-bold font-headline mb-6">Oldingi Buyurtmalar</h2>
